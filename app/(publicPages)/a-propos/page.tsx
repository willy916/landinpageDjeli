...
export const metadata = {
    title: "À propos — Djeli par Eso-dev",
    description: "Découvrez Eso-dev, la structure derrière Djeli, et les 3 fondateurs qui ont bâti l'application.",
};
...
const values = [
    {
        title: "Accessibilité",
        description: "Rendre les outils de gestion professionnelle accessibles à chaque commerçant, quelle que soit la taille de sa boutique.",
        icon: (
    ...
    },
    {
        ...
        description: "Concevoir des solutions technologiques pensées pour les réalités du marché africain, avec une profonde compréhension du terrain.",
        icon: (
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    {
        title: "Confiance",
        description: "Protéger les données et les finances de nos utilisateurs avec le plus haut niveau de sécurité et de transparence.",
        icon: (
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        <main className="min-h-screen pt-28 pb-24">
                ...
                <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <p className="text-slate-400 leading-relaxed mb-5">
                            <strong className="text-slate-200">Eso-dev</strong> est une startup technologique ivoirienne fondée à Abidjan. Notre mission est de développer des solutions digitales innovantes adaptées aux besoins spécifiques des entreprises africaines.
                        </p>
                        <p className="text-slate-400 leading-relaxed mb-5">
                            Djeli est notre produit phare — une application mobile de gestion commerciale conçue pour les commerçants et petites entreprises de Côte d'Ivoire et de l'espace CEDEAO.
                        </p>
                        <p className="text-slate-400 leading-relaxed">
                            Basés à <strong className="text-slate-200">Abidjan Cocody, Angré</strong>, nous croyons profondément que la technologie peut transformer le quotidien des entrepreneurs africains.
                        </p>
                    </div>
            ...
            <section className="px-4 md:px-16 lg:px-24 xl:px-32 mb-24">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-14">
                        <div className="text-xs font-medium text-[#7a18ea] tracking-widest uppercase mb-4">L'équipe fondatrice</div>
                        <h2 className="text-3xl md:text-4xl font-medium">Les 3 co-fondateurs</h2>
                        <p className="text-slate-400 mt-4 max-w-xl mx-auto">
                            Trois entrepreneurs passionnés réunis autour d'une même vision : révolutionner la gestion commerciale en Afrique de l'Ouest.
                        </p>
                    </div>
            ...
            <section className="px-4 md:px-16 lg:px-24 xl:px-32">
                <div className="max-w-2xl mx-auto text-center p-10 rounded-2xl border border-[#7a18ea]/20 bg-[#7a18ea]/5">
                    ...
                    <p className="text-slate-400 mb-6">L'équipe Eso-dev est disponible pour répondre à toutes vos demandes.</p>
                    <a
